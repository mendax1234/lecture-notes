...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/Sp0XaarBjbEX3JIMrRaR/textbook-2-synopsys/basic-concepts/synthesis-environment
---
...
{% hint style="success" %}
It will be good to review the [logic synthesis](/broken/pages/5JRrhLDHAesj12nSOZu1#logic-synthesis-1) process from EE4415 Lec 03a! The logic synthesis includes:
