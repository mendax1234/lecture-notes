...
- **Notes Structure**: View the [MA1512 Lecture Notes](https://github.com/mendax1234/lecture-notes/tree/main/Y1S1/MA1512)
    1. **MA1512-Notes**: This folder contains a comprehensive version of my notes, designed to break down and explain each concept covered in the course in a clear and easy-to-understand manner.  
    2. **MA1512-Cheatsheet**: Here, you'll find the cheatsheet I created and used throughout the course, summarizing key formulas and methods for quick reference.  
...
![MA1512 Coursebook](../../assets/images/MA1512_Textbook.jpg){ width=200 style="display: block; margin: 0 auto" }
...
![MA1512 Referencebook](../../assets/images/MA1512_Referencebook.jpg){ width=200 style="display: block; margin: 0 auto" }
