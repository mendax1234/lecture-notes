...
- **Notes Structure**: View the [CG1111A Lecture Notes](https://github.com/mendax1234/lecture-notes/tree/main/Y1S1/CG1111A)
    1. **CG1111A-Notes**: This folder contains a comprehensive version of my notes, designed to break down and explain each concept covered in the course in a clear and easy-to-understand manner.
    2. **CG1111A-Cheatsheet**: Here, you'll find the cheatsheet I created and used throughout the course, summarizing key formulas and methods for quick reference.
    3. **CG1111A-Final-Project**: This folder contains everything for our Team *Hello World*'s (B06 S2 T4) final project.
...
![CG1111A Coursebook](../../assets/images/CG1111A_Coursebook.jpg){ width=200 style="display: block; margin: 0 auto" }
