...
* First half is conducted by Prof. Massimo, which is focused on **digital design flow**:
  * **Timing Synchronous**: The register's timing charasteristics like setup time and hold time will be introduced here. Will also study how the skew and jitter affects the performance of a digital circuit in a systemetic manner.
  * **RTL Transformations**: This is the highlight of this course! Most of the RTL transformation skills are exclusive to Prof. Massimo's Green-IC group and cannot be found elsewhere on the Internet. These skills are very very useful in digital circuit design to improve the performance!
  * **Digital Design Flow**: This is an introduction to the ASIC design flow, where I highly recommend to have a relook at this topic when learning the technology mapping and physical synthesis topic from EE4218! This will deepen your understanding of the ASIC design flow.
  * **Verilog Fundamentals**: This is just a recap of the characteristics of the Verilog HDL.
* Second half is conducted by Prof. Kelvin, which is focused on the **analog design flow**, where the topics are very very much similar to CG2027, but are covered in greater details.
  * **MOSFET and CMOS Process**
  * **CMOS Inverter**
  * **Combinational Logic Circuits**
  * **Layout & Parasitics**: This is new in EE4415 and is not covered in CG2027.
  * **Sequential Circuits**
  * **Memories**
...
To be honest, EE4415 does not provide many application-based examples beyond the labs designed by the teaching team. That said, the labs and homework give students the opportunity to work with state-of-the-art EDA tools such as Synopsys and Cadence, which is a valuable and exciting experience.

However, these tools can be quite challenging for beginners, and the manuals may not always be fully up to date. As a result, students may sometimes struggle to understand the purpose or effect of certain operations.

One of the most useful takeaways from this course is the RTL transformation techniques. I would highly recommend applying these skills whenever you work on RTL code, as they are very practical and effective. I personally used them in my VNN project for EE4218, and they proved to be very helpful!

#### Challenging or Unique Aspects

* **RTL Transformation:** To be honest, the first half of the course may seem difficult to understand at first glance. However, trust me that Prof. Massimo will explainthe concepts very clearly and makes sure that students understand each step of the RTL transformation process. These techniques are extremely useful, and once you understand the logic behind them, they are not as difficult as they may initially seem. Instead, as Prof. Massimo said, they are very very **intuitive**!
...
I would especially recommend paying close attention during Prof. Massimo's lectures. From my experience, some of the content he teaches is not available online (exclusive to his Green-IC group), and since he has a very busy schedule, students may not always have many opportunities to clarify questions after lecture. Therefore, it is important to cherish the lecture time and make the most of it!

#### Labs/Homework

All the labs are individual and conducted online. In general, students are expected to read the lab or homework instruction manuals and complete the required tasks independently.
...
* **Midterm:** There is only one written test in EE4415, which is the midterm. To be honest, the midterm is not too difficult, as Prof. Massimo mainly aims to assess students' understanding of the concepts taught in the first half of the course. In general, there are no overly tricky or unexpected questions, and he will make sure that the requirements are clearly explained during the test. (In my cohort, there is one question that require use to write RTL code by hand)
* **Labs and Homework:** A large portion of the course grade comes from the labs and homework. As mentioned above, both are take-home and OTOT, so students have flexibility in completing them. To get the most out of these assignments, both in terms of marks and learning, I strongly recommend clarifying doubts with the lab TAs or Prof. Kelvin whenever possible, especially since two of the homework assignments are related to the second half of the course only.
...
Personally, I was very impressed by the RTL transformation techniques taught by Prof. Massimo. They are highly practical and can be very useful in real-world AI accelerator design!

At the same time, I believe that the transistor-level knowledge covered in the course will also be valuable for integrated circuit design. I hope to eventually experience a “full-circle moment” where both the high-level RTL techniques and low-level circuit knowledge come together in future projects or industry work.
