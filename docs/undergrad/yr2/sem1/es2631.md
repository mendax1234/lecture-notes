# ES2631 Critical Thinking and Writing
...
* **Notes Structure**: View the [ES2631 Lecture Notes](https://github.com/mendax1234/lecture-notes/tree/main/Y2S1/ES2631)
  * **ES2631-Notes**: The file `ES2631_Notes.pdf` contains the notes I made while studying this course.
...
**Textbook**: _The thinker's guide to engineering reasoning: based on critical thinking concepts and tools_ by Richard Paul, Robert Niewoehner and Linda Elder.

<figure><img src="../../.gitbook/assets/ES2631_Textbook.jpg" alt="" width="188"><figcaption></figcaption></figure>
...
I distinctly remember proposing an innovative idea aimed at solving a real problem I encountered on campus. The same problem had been encountered by my group member as well. However, it was rejected solely because it did not qualify as a "significant engineering problem" under the course's requirements — despite the fact that the definition of what constitutes a "significant problem" is itself highly subjective.
