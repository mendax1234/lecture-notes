...
{% hint style="info" %}
We are allowed to have pointers pointing to **arbitrary region in memory**, but as long as we don’t [**access**](#user-content-fn-3)[^3] those memory, we are not doing anything illegal.
{% endhint %}
