...
{% hint style="success" %}
It will be good to review the [logic synthesis](../../part-1-lec-digital-design-flow/lec-3/lec-3a-digital-design-flow.md#logic-synthesis-1) process from EE4415 Lec 03a! The logic synthesis includes:
