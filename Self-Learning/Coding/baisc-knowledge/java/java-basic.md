...
1. An array of objects is an array of **reference variables**.
   *   When an array of objects is created using the `new` operator,
       ...
       <pre class="language-java" data-line-numbers><code class="lang-java">Circle[] circleArray = new Circle[10];
       </code></pre>
       ...
       <pre class="language-java" data-line-numbers><code class="lang-java">for (int i = 0; i &#x3C; circleArray.length; i++) {
...
1. The `this` keyword refers to the **object itself**.
   *   Using `this` to Reference Data Fields,
       ...
       <pre class="language-java" data-line-numbers><code class="lang-java">private double radius;
   ...
   *   Using `this` to Invoke a Constructor The `this` keyword can be used to invoke another constructor of the same class.
       ...
       <pre class="language-java" data-line-numbers><code class="lang-java">public class Circle {
