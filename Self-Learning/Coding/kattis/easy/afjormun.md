...
To read a line in C, it is "safer" to use `fgets()`. See more about it in [Lec 11 - Strcut & Standard I/O #fgets](https://app.gitbook.com/s/KipySCGxC8NC1UpA24DS/lec-tut-lab-exes/lecture/lec-11-strcut-and-standard-i-o#fgets "mention").
