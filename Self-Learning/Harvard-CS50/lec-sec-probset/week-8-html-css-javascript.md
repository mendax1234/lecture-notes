...
1.  CSS
    ...
    * The general structure
    ...
    <pre class="language-css" data-line-numbers><code class="lang-css">selector {
        property: value;
        property: value;
    }
    </code></pre>
    ...
    * The `id` selector
    ...
    <pre class="language-css" data-line-numbers><code class="lang-css">#id {
        property: value;
    }
    ...
    * The `class` selector
    ...
    <pre class="language-css" data-line-numbers><code class="lang-css">.class {
        property: value;
    }
