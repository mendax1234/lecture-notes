...
1.  Validate the `key`
    ...
    <pre class="language-c" data-line-numbers><code class="lang-c">int validate_key(string key)
    {
        int i, l, j;
    ...
    <pre class="language-c" data-line-numbers data-full-width="true"><code class="lang-c">int validate_key(string key)
    {
        int record[26] = {0};
