...
This section focuses on **RTL transformation**. The motivation is simple: if someone asks for a **2× improvement in throughput**, how should we modify the RTL to achieve it?
