...
metaLinks:
  alternates:
    - /broken/spaces/W45nwClYZdzz9MQG1dUb/pages/a1MfejJl1qx8xery489M
---
...
{% hint style="success" %}
CAD tools represent circuits as graphs. More on Data Flow Graph (DFG) is on [EE4415](https://app.gitbook.com/s/Sp0XaarBjbEX3JIMrRaR/part-1-lec-digital-design-flow/lec-2b-rtl-transformations#data-flow-graphs).
{% endhint %}
