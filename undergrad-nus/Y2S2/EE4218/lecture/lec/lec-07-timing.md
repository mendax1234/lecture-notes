...
metaLinks:
  alternates:
    - /broken/spaces/W45nwClYZdzz9MQG1dUb/pages/4U3LZFLgSaLCBNvJ5Uuz
---
...
Similar to the [`set_max/min_delay`](https://app.gitbook.com/s/GFmM0S0eSJLSE772wZne/textbook-synopsys/constraining-designs/environment-and-constraints#set_max_delay) command we have seen in Synopsys, in Vivado, this command is to set maximum/minimum delays between any two points.
