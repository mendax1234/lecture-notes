...
metaLinks:
  alternates:
    - /broken/spaces/o4JqYVwVk7U2q66ddB5L/pages/Jzoje5you3j8KCAHvXFS
---
...
{% hint style="success" %}
In the Synopsys's [setup timing report](/broken/pages/OZXlIFP6DBFkqX5tyZeG#setup-timing-report), you will find out that this is equivalent to the **data required time** and **data arrival time**. The [timing diagram](/broken/spaces/W45nwClYZdzz9MQG1dUb/pages/wXaTn7J6x2JHUJ6aN5eY#setup-time) in EE4218 is very useful as well!
{% endhint %}
{% endstep %}
...
{% hint style="success" %}
In the Synopsys's [hold timing report](/broken/pages/OZXlIFP6DBFkqX5tyZeG#setup-timing-report), you will find out that this is equivalent to the **data required time** and **data arrival time**. The [timing diagram](/broken/spaces/W45nwClYZdzz9MQG1dUb/pages/wXaTn7J6x2JHUJ6aN5eY#hold-time) in EE4218 is very useful as well!
{% endhint %}
{% endstep %}
