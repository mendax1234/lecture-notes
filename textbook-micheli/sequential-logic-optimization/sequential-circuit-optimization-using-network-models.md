...
{% hint style="warning" %}
The combination of **retiming** and **network transformation** is combined into one thing call "[RTL Transformation](https://app.gitbook.com/s/Sp0XaarBjbEX3JIMrRaR/part-1-lec-digital-design-flow/lec-02/lec-02b-rtl-transformations)" which is introduced in NUS EE4415.
{% endhint %}
