...
{% hint style="info" %}
NUS EE4415 also has some notes on [latency](https://app.gitbook.com/s/Sp0XaarBjbEX3JIMrRaR/lecture/lec-01/lec-01b-timing-synchronous#latency), which are quite good to refer to!
{% endhint %}
{% endstep %}
...
{% hint style="info" %}
NUS EE4415 also has some notes on [throughput](https://app.gitbook.com/s/Sp0XaarBjbEX3JIMrRaR/lecture/lec-01/lec-01b-timing-synchronous#throughput), which are quite good to refer to!
{% endhint %}
{% endstep %}
{% endstepper %}
